...
public class CommodityTest {
    ...
    /**
     * Test of getClothesSectionAds method, of class Commodity This test will
     * check if the method is reading the file and storing the content of
     * CLOTHES section and only CLOTHES section into Array list By checking if
     * the method includes the name of the commodity that is in the CLOTHES
     * section if the method is working, it supposed to pass.
     */
    @org.junit.Test
    ...
    /**
     * Test of getAdsForVendor method, of class Commodity this test will check
     * if the method containing the ads of specific a vendor.
     */
    @Test
    ...
    /**
     * Test of deleteCommodity method, of class Commodity this method will take
     * the name of the commodity and delete it from the file, the test will pass
     * if and only if the file doesn't contain the name of the deleted
     * commodity.
     *
     */
    @Test
