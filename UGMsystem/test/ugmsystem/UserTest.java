...
/*
 ...
 /*   @Test
    public void testSetlName() throws Exception {
        ...
        User instance = findUser("33536336");
        System.out.println("instance "+ instance.getId());
        instance.setlName(lName);
        assertTrue(instance.getlName().equals(lName));
    }
    /**
  ...
  /*  @Test
    public void testUpdate() throws Exception {
        ...
        String newUpdate = "Mohammad";
        User instance = Buyer.findUser("33536336");
        instance.Update(newUpdate);
        assertTrue(instance.getlName().equals(newUpdate));
    } */
